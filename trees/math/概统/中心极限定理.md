...
由于我们可以将 [二项分布](./二项分布.md) $B(n,p)$ 视为一系列独立同分布的 [两点分布](./二项分布.md), 此时由 Lindeberg--Lévy 中心极限定理就得到 De Moivre -- Laplace 定理. 我们也可以考虑 $X_i$ 的均值 $\overline X = \frac{1}{n} \sum_i X_i$, 此时 $D(\overline X) = \frac{1}{n^2}D(\sum_i X_i) = \frac{\sigma^2}{n}$, 故 $\overline X \spaces\sim N(\mu, \tfrac{\sigma^2}{n})$. 

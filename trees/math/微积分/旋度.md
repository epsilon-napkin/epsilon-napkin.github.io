...
与 [梯度和散度](./微分算子.md) 不同, 向量微积分中表述的旋度不能简单地推广到其他维度, 虽然存在某些推广形式, 但只有在三维空间中, 几何定义的向量场旋度才能再次表现为向量场, 此问题有 Hodge 星算子的解释. [旋度定理](./kelvin-stokes.md) 指出, 向量场的旋度通过曲面的通量等于该向量场沿曲面边界的环量. 
